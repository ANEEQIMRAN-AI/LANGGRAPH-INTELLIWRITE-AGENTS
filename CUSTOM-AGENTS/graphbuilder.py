...
def build_essay_graph():
    ...
    graph.add_node("llm", run_tool("EssayWriter", "topic", "essay"))
    graph.add_node("h_agent", run_tool("Humanizer", "essay", "human_essay"))
    graph.add_node("g_agent", run_tool("GrammarCorrector", "human_essay", "corrected_essay"))
    graph.add_node("p_agent", run_tool("PlagiarismReducer", "corrected_essay", "final_output"))
